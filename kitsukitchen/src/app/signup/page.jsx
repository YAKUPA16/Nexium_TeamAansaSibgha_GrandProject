...
export default function SignupPage() {
  ...
  return (
    ...
    >
      <form onSubmit={handleSignup} className="bg-[#97572b] p-8 rounded-2xl shadow-lg w-full max-w-md space-y-6">
        ...
        <p className="text-center text-white mt-4">
          ...
          <a href="/" className="underline text-[#ffca52] hover:text-[#f78f48]">Login</a>
        </p>
      </form>
    </main>
  );
